...
const OptimizedRoute = {
    upsert({ originCode, destinationCode, optimizationType, path, totalDistance, totalDuration, totalCost, totalLayover = 0 }) {
        return getDb().prepare(`
            INSERT INTO optimized_routes
                (origin_code, destination_code, optimization_type, path_codes,
                 total_distance_km, total_duration_min, total_cost_usd,
                 total_layover_min, segment_count, computed_at)
            ...
            DO UPDATE SET
                ...
                total_layover_min  = excluded.total_layover_min,
    ...
    getHistory(limit = 15) {
        return getDb().prepare(`
            SELECT
                ...
                r.total_layover_min, r.segment_count, r.computed_at,
